...
<head>
    ...
    <link rel='stylesheet' type='text/css'  href='css/estilos.css?v=0.0.24'/>
...
<body>
    <div class="contenedor2">
		<div class="menu-lateral">
			...
			<div class="name3"> <a   href="#">Bienvenido a la seccion del Administrador</a></div><br>


			<img src="img/ilustracion.jpg"  height="350px" width = "500px">  
